...
st.title("🎣 Prediksi Spesies Ikan dengan Support Vector Machine")
...
if st.button("🔍 Prediksi Spesies"):
    ...
    svm_model = joblib.load('Supervised Support Vector Machine/SVM_Scaler_Model.pkl')
    scaler    = joblib.load('Supervised Support Vector Machine/SVM_Scaler.pkl')
    le        = joblib.load('Supervised Support Vector Machine/SVM_Scaler_LabelEncoder.pkl')
